...
using AcuTestRestAPI.Contracts.v1.Requests.auth;
using AcuTestRestAPI.Contracts.v1.Response.abs;
using AcuTestRestAPI.Contracts.v1.Response.auth;
using AcuTestRestAPI.Model;
using AcuTestRestAPI.Services.Interfaces.v1.auth;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;
using AcuTestRestAPI.Installers;

namespace AcuTestRestAPI.Controllers.v1.auth
{
    public class AuthenticationController : Controller
    {
        ...
        public async Task<IActionResult> RegisterUser([FromBody] UserRegistrationRequest request)
        {
            ...
            HttpContext.Session.SetString("Id", authResponse.ProfileId);
        ...
        private async Task<bool> SendEmail(string sender, string subject, string recipient, string url, int mailType)
        {
            ...
            try
            {
                ...
                client.Connect(SMTP.prot, SMTP.port, true);
