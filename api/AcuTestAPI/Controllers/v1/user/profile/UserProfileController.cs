...
using AcuTestRestAPI.Contracts.v1.Requests.user.profile;
using AcuTestRestAPI.Contracts.v1.Response.abs;
using AcuTestRestAPI.Contracts.v1.Response.user;
using AcuTestRestAPI.Extensions;
...
namespace AcuTestRestAPI.Controllers.v1.user.profile
{
